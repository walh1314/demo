<template>
      ...
      <el-container>
        <el-aside width="910px"><canvas width="900" height="600" id="canvas" class="lamp-canvas"
              ...
              <el-popover placement="bottom-start" width="400" trigger="click" v-model="visible" >
                <el-button slot="reference" @click="addPoints">添加</el-button>
                 <el-container  width="180px" >
                    <el-container  width="180px" >
                      <el-aside width="50%">
                          <el-form size="mini" ref="form" style="padding-top:10px;">
                              <el-form-item label="名称">
                                  <el-input v-model="form.name" placeholder="请输入名称" style="min-width:120px;max-width:150px"></el-input>
                              </el-form-item>
                              <el-form-item label="类型">
                                  <el-select v-model="form.type" placeholder="请选择" style="min-width:120px;max-width:150px">
                                    <el-option  v-for="_item in types" :key="_item.value" :label="_item.label" :value="_item.value">
                                    </el-option>
                                  </el-select>
                              </el-form-item>
                              <el-form-item label="编号">
                                  <el-input v-model="form.identifier" placeholder="请输入编号" style="min-width:120px;max-width:150px"></el-input>
                              </el-form-item>
                              <el-form-item label="备注">
                                  <el-input style="min-width:120px;max-width:150px" v-model="form.remark"  type="textarea" :autosize="{minRows: 1, maxRows: 2}" placeholder="请输入备注"></el-input>
                              </el-form-item>
                          </el-form>
                      </el-aside>
                        <el-main width="50%">
                          <el-form size="mini" ref="form" style="padding-top:10px;">
                              <el-form-item  v-for="(point,_index) in form.points" :key="point.id" 
                                :label="(_index ==0 ?'左上':(_index ==1 ?'右上': (_index ==2 ?'右下':(_index ==3 ?'左上':'' ) )) ) "
                                 style="padding-left:6px;">
                                  <el-input v-if="_index == 0" style="min-width:120px;max-width:150px" :disabled="true" :value="'(x:'+point.x+',y:'+point.y+')'"></el-input>
                                  <el-input v-if="_index == 1" style="min-width:120px;max-width:150px" :disabled="true" :value="'(x:'+point.x+',y:'+point.y+')'"></el-input>
                                  <el-input v-if="_index == 2" style="min-width:120px;max-width:150px" :disabled="true" :value="'(x:'+point.x+',y:'+point.y+')'"></el-input>
                                  <el-input v-if="_index == 3" style="min-width:120px;max-width:150px" :disabled="true" :value="'(x:'+point.x+',y:'+point.y+')'"></el-input>
                              </el-form-item>
                          </el-form>
                        </el-main>
                      </el-container>
