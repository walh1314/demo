...
import com.foxconn.lamp.mqtt.config.MqttClientProperties;
...
public class ClientMQTT
{
	...
	public static final String HOST = "tcp://192.168.1.23:1883";
	...
	public void init(){
		...
		//client = new MqttClient(mqttClientProperties.getHost(), mqttClientProperties.getClientid(), new MemoryPersistence());
